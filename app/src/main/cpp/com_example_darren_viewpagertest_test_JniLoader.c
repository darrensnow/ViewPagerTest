...
#include <stdlib.h>
#include "include/elian/elian.h"
#include "include/com_example_darren_viewpagertest_test_JniLoader.h"
...
/*
 * Class:     com_example_darren_viewpagertest_test_JniLoader
 * Method:    GetProtoVersion
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_example_darren_viewpagertest_test_JniLoader_GetProtoVersion
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_example_darren_viewpagertest_test_JniLoader_GetLibVersion
  (JNIEnv *env, jobject object)
{
    int proVersion = 0;
    int libVersion = 0;
 ...
 */
JNIEXPORT jint JNICALL Java_com_example_darren_viewpagertest_test_JniLoader_InitSmartConnection
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_com_example_darren_viewpagertest_test_JniLoader_SetSendInterval
 ...
 */
JNIEXPORT jint JNICALL Java_com_example_darren_viewpagertest_test_JniLoader_StartSmartConnection
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_example_darren_viewpagertest_test_JniLoader_StopSmartConnection
  (JNIEnv *env, jobject object)
{
    if (context)
	{
